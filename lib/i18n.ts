...
const translations = {
  en: {
    ...
    "account.concurrencyCapacity": "Concurrency capacity",
    "account.concurrencySlots": "slots",
    "account.concurrencyUsed": "used",
    "account.concurrencyCapacityHelp": "Capacity limit is available; current occupancy is not reported.",
  ...
  "zh-CN": {
    ...
    "account.concurrencyCapacity": "并发容量",
    "account.concurrencySlots": "路",
    "account.concurrencyUsed": "占用",
    "account.concurrencyCapacityHelp": "已获取容量上限，当前占用未由上游返回。",
  ...
  "zh-TW": {
    ...
    "account.windowTokens": "Token",
    "account.concurrencyCapacity": "並發容量",
    "account.concurrencySlots": "路",
    "account.concurrencyUsed": "佔用",
    "account.concurrencyCapacityHelp": "已取得容量上限，目前佔用未由上游返回。",
